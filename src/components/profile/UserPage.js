  ...
  return (
    <div>
      ...
      <Nav variant="tabs" defaultActiveKey={history.location.pathname}>
        <Nav.Item>
          <Nav.Link href={`${url}/${authorizedUser.id}`}>Likes</Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link href={`${url}/${authorizedUser.id}/collections`} eventKey={`${url}/${authorizedUser.id}/collections`}>Collections</Nav.Link>
        </Nav.Item>
      </Nav>
