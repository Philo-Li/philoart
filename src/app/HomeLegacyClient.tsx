          ...
          <form onSubmit={handleHeroSearch} className="w-full max-w-xl">
            <div className="relative group">
              <input
                ...
                className="w-full px-7 py-4 pr-14 rounded-full bg-transparent text-white text-base placeholder-white/40 border border-white/30 outline-none focus:bg-white/15 focus:border-white/60 focus:backdrop-blur-md transition-all duration-300"
              />
              <button
                type="submit"
