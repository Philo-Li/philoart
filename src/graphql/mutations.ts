...
export const UNCOLLECT_PHOTO = gql`
  mutation deleteColletedPhoto($photoId: ID!, $collectionId: ID!) {
    deleteCollectedPhoto(
      uncollect: { photoId: $photoId, collectionId: $collectionId }
    )
  }
`;
...
export const CREATE_COLLECTION = gql`
  mutation createCollection(
    ...
    createCollection(
      collection: { title: $title, description: $description, public: $public }
    ) {
      id
      title
      description
...
export const CREATE_COLLECTION_AND_COLLECT_PHOTO = gql`
  mutation createCollectionAndCollectPhoto(
    ...
    createCollectionAndCollectPhoto(
      collection: {
        title: $title
        description: $description
        public: $public
...
export const CHANGE_PASSWORD = gql`
  mutation changePassword($currentPassword: String!, $newPassword: String!) {
    changePassword(
      user: { currentPassword: $currentPassword, newPassword: $newPassword }
    )
  }
`;
